  ...
  return (
    <footer style={{ backgroundColor: "var(--brand-black)" }} className="py-12">
      <div className="container-brand">
        ...
        >
          <p className="font-body text-sm leading-relaxed mb-3" style={{ color: "rgba(138,170,154,0.6)" }}>
            <strong style={{ color: "rgba(138,170,154,0.9)" }}>Отказ от финансовых рекомендаций:</strong> Все материалы программы носят исключительно образовательный и информационный характер. Ничто из представленного не является индивидуальной инвестиционной рекомендацией, советом по управлению активами или финансовым консультированием в соответствии с законодательством Российской Федерации. Перед принятием инвестиционных решений рекомендуется обратиться к лицензированному финансовому советнику.
          </p>
          <p className="font-body text-sm leading-relaxed mb-3" style={{ color: "rgba(138,170,154,0.6)" }}>
            <strong style={{ color: "rgba(138,170,154,0.9)" }}>Отсутствие гарантий дохода:</strong> Результаты участников программы зависят от индивидуальных усилий, финансового положения, рыночной конъюнктуры и иных факторов, не зависящих от организаторов. Любые упоминания доходов или финансовых результатов являются иллюстративными и не гарантируют аналогичного результата для каждого участника.
          </p>
          <p className="font-body text-sm leading-relaxed mb-6" style={{ color: "rgba(138,170,154,0.6)" }}>
            <strong style={{ color: "rgba(138,170,154,0.9)" }}>Законодательный дисклеймер:</strong> Программа реализуется в соответствии с законодательством Российской Федерации. Деятельность по организации обучения осуществляется ИП Коргун Надежда Сергеевна на основании ОГРНИП 322253600076170. Услуги не являются деятельностью, подлежащей лицензированию в соответствии с Федеральным законом «Об образовании в Российской Федерации» (ст. 91), поскольку реализуются в форме разовых занятий и наставничества без итоговой аттестации и выдачи документов об образовании.
          </p>
        </div>
