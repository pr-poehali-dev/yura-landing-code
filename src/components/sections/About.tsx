        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-6 pt-2">
            <div className="flex items-center gap-3">
              ...
              <span className="font-body text-base" style={{ color: "var(--brand-muted)" }}>Накопление капитала</span>
            </div>
            <div className="flex items-center gap-3">
              <IconTrendUp size={36} opacity={0.85} />
              <span className="font-body text-base" style={{ color: "var(--brand-muted)" }}>Рост активов</span>
            </div>
          </div>
        </div>
      </div>
